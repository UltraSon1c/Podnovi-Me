...
if($userConfig->isTruthy('publisher_id'))
{
	$metas[] = WblMvcLayout_Helper::render('weeblramp.frontend.amp.metadata.publisher', $this->getDisplayData(), WEEBLRAMP_LAYOUTS_PATH);
}
