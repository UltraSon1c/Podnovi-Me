...
$title = esc_attr(sprintf(__('Share %1$s on %2$s'), $this->get('share_title'), 'WhatsApp'));
$href = esc_attr('whatsapp://send?text=' . urlencode(sprintf(__('Read %1$s at '), $this->get('share_title')) . $this->get('share_url')));
?>
