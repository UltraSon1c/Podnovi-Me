	...
	array(
		...
		'content'         => array(
			...
			array(
				...
				'type'      => WblSystem_Config::OPTION_TEXT,
				'editions'  => array( WblSystem_Version::EDITION_COMMUNITY, WblSystem_Version::EDITION_FULL ),
				'title'     => __( 'Publisher ID', 'weeblramp' ),
				'desc'      => __( 'Optionally enter your Google+ publisher id, to be included in all AMP pages.', 'weeblramp' ),
				'doc_link'  => 'products.weeblramp/1/getting-started/site-meta-data.html#h2_publisher_information',
				'doc_embed' => true,
				'default'   => '',
				'class'     => '',
			...
			// Fallback elements section ---------------------------------------------------
			array(
				'name'     => 'section_fallback_elements',
				'type'     => WblSystem_Config::OPTION_SECTION,
				'editions' => array( WblSystem_Version::EDITION_COMMUNITY, WblSystem_Version::EDITION_FULL ),
				'title'    => __( 'Fallback elements', 'weeblramp' ),
				'icon'     => 'assets.icons.umbrella'
			),

			array(
				'name'         => 'pages_fallback_image',
				'type'         => WblSystem_Config::OPTION_MEDIA,
				'editions'     => array( WblSystem_Version::EDITION_COMMUNITY, WblSystem_Version::EDITION_FULL ),
				'title'        => __( 'Page image fallback', 'weeblramp' ),
				'desc'         => __( 'URL of an image to be used in case a page doesn\'t have an image associated with it. <strong>To be displayed in top stories</strong>, AMP pages must have an image associated with them, visible in the page or not. If we cannot find one, and you do not set up one explicitely, wbAMP will use this fallback image instead.', 'weeblramp' ),
				'doc_link'     => 'products.weeblramp/1/getting-started/site-meta-data.html#h2_fallback_image#h2_fallback_image',
				'doc_embed'    => true,
				'default'      => '',
				'class'        => '',
				'content'      => array(
	...
	array(
		...
		'content'         => array(
			...
			array(
				...
				'editions'  => array( WblSystem_Version::EDITION_COMMUNITY, WblSystem_Version::EDITION_FULL ),
				'title'     => __( 'Analytics', 'weeblramp' ),
				'desc'      => __( 'If enabled, an amp-analytics tag will be added to all AMP pages, using parameters set below. If the social buttons option is enabled, tracking code for social interactions will also be added.', 'weeblramp' ),
				'doc_link'  => 'products.weeblramp/1/going-further/analytics-tag/index.html#h2_analytics_type',
				'doc_embed' => true,
				'default'   => WeeblrampConfig_User::ANALYTICS_NONE,
				'class'     => '',
				'content'   => array(
					'attr'             => array(),
					'options'          => array(
						WeeblrampConfig_User::ANALYTICS_NONE     => __( 'None', 'weeblramp' ),
						WeeblrampConfig_User::ANALYTICS_STANDARD => __( 'Google Analytics', 'weeblramp' ),
						WeeblrampConfig_User::ANALYTICS_GTM      => array(
							'editions' => array( WblSystem_Version::EDITION_FULL ),
							'option'   => __( 'Google Tag Manager', 'weeblramp' )
						),
					),
					'options_callback' => array()
				)
			...
			array(
				...
				'desc'      => __( 'The Google Analytics web property ID. Similar to UA-XXXXX-Y.', 'weeblramp' )
				               . __( 'The AMP project recommends using a <strong>separate web property ID</strong> from that of your regular site id.', 'weeblramp' ),
			...
			array(
				...
				'desc'      => __( 'The Google Tag manager ID to use. Similar to GTM-XXXXXX.', 'weeblramp' )
				               . __( 'The AMP project recommends using a separate web property ID from that of your regular site id.', 'weeblramp' ),
				'doc_link'  => 'products.weeblramp/1/going-further/analytics-tag/index.html#h2_analytics_settings',
				'doc_embed' => true,
				'default'   => '',
				'class'     => '',
	...
	array(
		...
		'content'         => array(
			...
			array(
				...
				'type'     => WblSystem_Config::OPTION_TEXT,
				'editions' => array( WblSystem_Version::EDITION_COMMUNITY, WblSystem_Version::EDITION_FULL ),
				'title'    => __( 'aax_pubname', 'weeblramp' ),
				'desc'     => '',
				'default'  => '',
				'class'    => '',
				'content'  => array(
			...
			array(
				...
				'type'     => WblSystem_Config::OPTION_SECTION,
				'editions' => array( WblSystem_Version::EDITION_COMMUNITY, WblSystem_Version::EDITION_FULL ),
				'title'    => __( 'Doubleclick', 'weeblramp' ),
				'icon'     => 'assets.icons.gear',
				'show-if'  => array(
					'id'      => 'ads_network',
					'include' => 'doubleclick',
	...
	array(
		...
		'content'         => array(
			...
			array(
				...
				'desc'      => __( 'Plugins you select on this list will be <strong>disabled</strong> when displaying an AMP page. Some plugins are not shown as they will be disabled automatically (typically, other AMP plugins, which would otherwise conflict.)' ),
	...
	array(
		...
		'content'         => array(
			...
			array(
				...
				'desc'      => __( 'weeblrAMP can fetch some data from the plugins listed here, if installed and activated. If you disable an integration, we will also disable the corresponding plugin when displaying an AMP page.' ),
				...
				'content'   => array(
					...
					'options' => array(
						array(
							...
							'caption'  => __( 'Yoast SEO', 'weeblramp' ),
							'default'  => 1,
							'editions' => array( WblSystem_Version::EDITION_COMMUNITY, WblSystem_Version::EDITION_FULL ),
						),
						array(
							'name'     => 'jetpack/jetpack.php',
							'caption'  => __( 'JetPack', 'weeblramp' ),
							'default'  => 1,
							'editions' => array( WblSystem_Version::EDITION_COMMUNITY, WblSystem_Version::EDITION_FULL ),
						),
						array(
							'name'            => 'contact-form-7/wp-contact-form-7.php',
							'caption'         => __( 'Contact Form 7', 'weeblramp' ),
							'default'         => 1,
						...
						array(
							...
							'caption'         => __( 'Easy Digital Downloads', 'weeblramp' ),
							'default'         => 1,
							'default_edition' => array(
								WblSystem_Version::EDITION_COMMUNITY => 1,
							),
						...
						array(
							...
							'caption'         => __( 'Gravity Forms', 'weeblramp' ),
							'default'         => 1,
							'default_edition' => array(
								WblSystem_Version::EDITION_COMMUNITY => 1,
							),
						...
						array(
							...
							'caption'         => __( 'Mailchimp for WordPress', 'weeblramp' ),
							'default'         => 1,
							'default_edition' => array(
								WblSystem_Version::EDITION_COMMUNITY => 1,
							),
						...
						array(
							...
							'caption'         => __( 'WooCommerce', 'weeblramp' ),
							'default'         => 1,
							'default_edition' => array(
								WblSystem_Version::EDITION_COMMUNITY => 1,
							),
