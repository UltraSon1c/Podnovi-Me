	...
	array(
		...
		'content' => array(
			...
			array(
				...
				'type'     => WblSystem_Config::OPTION_SECTION,
				'editions' => array( WblSystem_Version::EDITION_COMMUNITY, WblSystem_Version::EDITION_FULL ),
				'title'    => __( 'Link to main site', 'weeblramp' ),
			),
			...
			array(
				...
				'type'      => WblSystem_Config::OPTION_LIST,
				'editions'  => array( WblSystem_Version::EDITION_COMMUNITY, WblSystem_Version::EDITION_FULL ),
				'title'     => __( 'Show link to main site', 'weeblramp' ),
				'desc'      => __( '', 'weeblramp' ),
				'doc_link'  => 'products.weeblramp/1/going-further/customization/page-layout-style.html',
				'doc_embed' => true,
			...
			array(
				...
				'desc'      => __( 'This text will be displayed on each AMP pages, normally to inform them that they are looking at an AMP page. You can enter raw HTML, so be very careful with your entry.', 'weeblramp' ),
				'doc_link'  => 'products.weeblramp/1/going-further/customization/page-layout-style.html',
				'doc_embed' => true,
			...
			array(
				...
				'desc'      => __( 'If you have entered some text above to inform your users, you can add here the text for a link that goes to your standard, non-amp main site.', 'weeblramp' ),
				'doc_link'  => 'products.weeblramp/1/going-further/customization/page-layout-style.html',
				'doc_embed' => true,
	...
	array(
		...
		'content' => array(
			...
			array(
				...
				'desc'      => __( 'Choose among various options to configure single posts output on AMP pages.' ),
			...
			array(
				...
				'editions'  => array( WblSystem_Version::EDITION_COMMUNITY, WblSystem_Version::EDITION_FULL ),
				'title'     => __( 'Display options', 'weeblramp' ),
				'desc'      => __( 'Choose among various options to configure page output on AMP pages.' ),
				'doc_link'  => 'products.weeblramp/1/going-further/customization/content-layout-style.html',
				'doc_embed' => true,
				'default'   => array(),
				'class'     => 'wbamp-settings-checkbox-group',
			...
			array(
				...
				'editions'  => array( WblSystem_Version::EDITION_COMMUNITY, WblSystem_Version::EDITION_FULL ),
				'title'     => __( 'Display options', 'weeblramp' ),
				'desc'      => __( 'Choose among various options to configure category and archive products output on AMP pages.' ),
				'doc_link'  => 'products.weeblramp/1/going-further/customization/content-layout-style.html',
				'doc_embed' => true,
				'default'   => array(),
				'class'     => 'wbamp-settings-checkbox-group',
			...
			array(
				...
				'editions'  => array( WblSystem_Version::EDITION_COMMUNITY, WblSystem_Version::EDITION_FULL ),
				'title'     => __( 'Display options', 'weeblramp' ),
				'desc'      => __( 'Choose among various options to configure home page output on AMP pages.' ),
				'doc_link'  => 'products.weeblramp/1/going-further/customization/content-layout-style.html',
				'doc_embed' => true,
				'default'   => array(),
				'class'     => 'wbamp-settings-checkbox-group',
			...
			array(
				...
				'desc'      => __( 'Choose among various options to configure comments output on AMP pages.' ),
				'doc_link'  => 'products.weeblramp/1/going-further/customization/content-layout-style.html',
				'doc_embed' => true,
				'default'   => array(),
				'class'     => 'wbamp-settings-checkbox-group',
			...
			array(
				...
				'editions'  => array( WblSystem_Version::EDITION_FULL ),
				'title'     => __( 'Display options', 'weeblramp' ),
				'desc'      => __( 'Choose among various options to configure search results output on AMP pages.' ),
				'doc_link'  => 'products.weeblramp/1/going-further/customization/content-layout-style.html',
				'doc_embed' => true,
				'default'   => array(),
				'class'     => 'wbamp-settings-checkbox-group',
	...
	array(
		...
		'content' => array(
			...
			array(
				...
				'desc'      => __( 'Select which menu to display on AMP pages, and whether links on those menu should go to the AMP version of the linked page. Use existing menu(s), or create AMP-specific one(s) as usual, on <a href="' . admin_url( 'nav-menus.php?action=edit' ) . '">this WordPress page</a>. ', 'weeblramp' ),
				'doc_link'  => 'products.weeblramp/1/going-further/customization/menus.html',
				'doc_embed' => true,
				'default'   => array(),
				'show-if'   => array(
	...
	array(
		...
		'content' => array(
			...
			array(
				...
				'desc'     => wbJoin(
					' ',
					__( 'Select social sharing buttons to display on AMP pages.' ),
					__( 'When using a Facebook button, enter your Facebook App id under the <strong>SEO</strong> tab.' ),
					__( 'When using a Tweet button, enter your Twitter account under the <strong>SEO</strong> tab.' ),
					__( 'WhatsApp buttons are only displayed on phones.' )
				),
				'default'  => array(),
				'show-if'  => array(
					'id'      => 'social_buttons_location',
				...
				'content'  => array(
					...
					'options' => array(
						...
						array(
							...
							'caption' => __( 'Google+ share', 'weeblramp' ),
							'default' => 1
						),
						array(
							'name'    => 'linkedin_share',
